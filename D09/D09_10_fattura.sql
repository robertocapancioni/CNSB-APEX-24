...
drop table d09_fattura_testata cascade constraints;
drop table d09_fattura_dettaglio cascade constraints;
...
create table d09_fattura_testata (
    id                             number generated by default on null as identity 
                                   constraint d09_fattura_testat_id_pk primary key,
    cliente_id                     number
                                   constraint d09_fattura_tes_cliente_id_fk
...
-- table index
create index d09_fattura_testat_i1 on d09_fattura_testata (cliente_id);

create table d09_fattura_dettaglio (
    id                             number generated by default on null as identity 
                                   constraint d09_fattura_dettag_id_pk primary key,
    fattura_testata_id             number
                                   constraint d09_fattura_d_fattura_testa_fk
                                   references d09_fattura_testata not null,
...
-- table index
create index d09_fattura_dettag_i1 on d09_fattura_dettaglio (fattura_testata_id);
